export const eventsData = [
    {
        ...
        fullDescription: 'Immerse yourself in a cyberpunk atmosphere and let the code flow. Vibe Coding is not just about the final product; it is about the journey, the rhythm, and the aesthetics of your code. Judges will evaluate your creativity, the elegance of your logic, and how well your code aligns with the retro-futuristic theme.',
        rules: [
            'Participants must bring their own laptops.',
            'Any programming language can be used.',
            'Use of AI tools is restricted and monitored.',
            'Plagiarism will result in immediate disqualification.'
        ],
        coordinators: ['Alex (Dept. of CSE)', 'Sarah (Dept. of IT)'],
        prize: '₹5,000 + Exclusive Techxell Merch',
        date: 'March 18, 2026',
        time: '10:00 AM - 01:00 PM',
        venue: 'Main Computer Lab (Room 304)',
        isTeamEvent: true
    },
    {
        id: 'treasure-hunt',
        ...
        coordinators: ['Rahul (Dept. of ECE)', 'Priya (Dept. of Mech)'],
        prize: '₹7,500 + Mystery Gadget',
        date: 'March 18, 2026',
        time: '02:00 PM - 05:00 PM',
        venue: 'Campus Wide (Starts at Main Stage)',
        isTeamEvent: true
    },
    {
        id: 'computer-quiz',
        ...
        coordinators: ['Dr. Vikram (Faculty In-Charge)', 'Neha (Dept. of CSE)'],
        prize: '₹3,000 + Tech Books Bundle',
        date: 'March 18, 2026',
    ...
    },
    {
        ...
        coordinators: ['Karan (Design Club)', 'Sneha (Design Club)'],
        prize: '₹4,000 + Drawing Tablet',
        date: 'March 18, 2026',
        time: '09:00 AM - 11:00 AM',
        venue: 'Design Studio (Room 102)'
    },
    {
        id: 'reel-making',
        stageNumber: 5,
        ...
        coordinators: ['Arjun (Media Team)', 'Ravi (Media Team)'],
    ...
    },
    {
        ...
        coordinators: ['Vikash (Esports Club)', 'Manoj (Esports Club)'],
    ...
    },
    {
        ...
        coordinators: ['Suraj (Esports Club)', 'Tarun (Esports Club)'],
